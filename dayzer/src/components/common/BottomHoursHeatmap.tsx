...
export default function BottomHoursHeatmap() {
  ...
  if (loading) {
    return (
      <div className="bg-white p-6 rounded-lg shadow-gs-sm border-l-4 border-gs-green-500 flex items-center justify-center" style={{ height: '400px' }}>
        <div className="text-gs-gray-500">Loading bottom hours...</div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-gs-sm border-l-4 border-gs-green-500" style={{ height: '400px' }}>
      <h3 className="text-lg font-semibold text-gs-gray-900 mb-4">Bottom Hours Frequency</h3>
